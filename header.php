...
<html lang="en">
    <head>
        ...
        ================================================== -->
        <meta charset="utf-8">
        <title>Selim Tirellil - Game Developer</title>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <ul class="nav-top-social">
                        <li class="github">
                            <a href="https://github.com/selimbat" target="_blank">Github</a>
                        </li>
                        <li class="linkedin">
                ...
                <div class="col-md-12">
                    <nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse bg-faded nav-line-top">
                        ...
                        <a class="navbar-brand" href="./index.php">
                            <h3 class="title" style="color: white; padding: 0">Selim Tirellil</h3>
                        </a>
